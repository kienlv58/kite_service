...
public final class LoginService {
	...
	public static LoginResult doLogin(Context context, String username, String password, boolean force, boolean encodepass) {
		...
		try {
			...
			RestfulResult result = RestfulClient.doRequest(context, "POST", Settings.SERVER_LOGIN_URL, RestfulClient.getGSON().toJson(request), true);
