...
public class FotoAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(item != null) {
            if(item.toLowerCase().endsWith("jpg") || item.toLowerCase().endsWith("png")){
                ...
                File videoFile = new File(ImageUtils.getPath(getContext(), true), item);
            ...
            if (mode != MunkalapActivity.MODE_VIEW && mode != MunkalapActivity.MODE_OWN || (mode == MunkalapActivity.MODE_OWN && !originalObjects.contains(item))) {
                ...
                holder.removebtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final File imageFile = new File(ImageUtils.getPath(getContext(), true), imageName);
    ...
    class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            data = params[0];
            final Bitmap bitmap = ImageUtils.loadUploadableImageWithResize(getContext(), data, 160, 90, true);
