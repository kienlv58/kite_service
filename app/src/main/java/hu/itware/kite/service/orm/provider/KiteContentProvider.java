...
public class KiteContentProvider extends ContentProvider {
	...
	private KiteDatabaseHelper database;
	...
	public boolean onCreate() {
		...
		database = new KiteDatabaseHelper(getContext());
		return true;
	}
	...
	public long insert(String table, ContentValues values) {
		...
		try {
			beginTransaction();
			long res = database.getWritableDatabase().insertWithOnConflict(table, null, values, SQLiteDatabase.CONFLICT_REPLACE);
	...
	public int update(String table, ContentValues values, String whereClause, String[] whereArgs) {
		...
		try {
			beginTransaction();
			int res = database.getWritableDatabase().update(table, values, whereClause, whereArgs);
			setTransactionSuccess();
			return res;
		} finally {
			endTransaction();
	...
	public long delete(String table, String where, String[] whereArgs) {
		...
		try {
			beginTransaction();
			res = database.getWritableDatabase().delete(table, where, whereArgs);
			setTransactionSuccess();
		} finally {
			endTransaction();
		}
	...
	public KiteDatabaseHelper getDatabase() {
		return database;
	}
